    ...
    <div class="row">
        ...
        {{-- <div class="form-group quantity">--}}
            {{-- <div class="d-flex radio-check ">--}}
                {{-- <div class="form-check form-check-inline form-group col-md-6">--}}
                    {{-- <input type="radio" id="plus_quantity" value="Add" name="quantity_type"
                        class="form-check-input" checked="checked">--}}
                    {{-- <label class="form-check-label" for="plus_quantity">{{__('Add Quantity')}}</label>--}}
                    {{-- </div>--}}
                {{-- <div class="form-check form-check-inline form-group col-md-6">--}}
                    {{-- <input type="radio" id="minus_quantity" value="Less" name="quantity_type"
        ...
        @forelse ($warehouses as $warehouse)
            <div class="form-group col-md-12">
                {{ Form::label('quantity', __($warehouse->name), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                {{ Form::number('quantity-' . $warehouse->id, "", array('class' => 'form-control', 'required' => 'required')) }}
            </div>
        @empty
            <div class="form-group col-md-12">
