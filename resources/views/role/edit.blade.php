    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-account-tab" data-bs-toggle="pill" href="#customer_services"
                        role="tab" aria-controls="pills-contact"
                        aria-selected="false">{{ __('Customer Services') }}</a>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <td>
                                                    <div class="row ">
                                                        ...
                                                        @if (in_array('manage ' . $module, (array) $permissions))
                                                            ...
                                                            @endif
                                                        @endif
                                                        @if (in_array('initiate ' . $module, (array) $permissions))
                                                            @if ($key = array_search('initiate ' . $module, $permissions))
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    {{ Form::checkbox('permissions[]', $key, $role->permission, ['class' => 'form-check-input isscheck hrm_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                                    {{ Form::label('permission' . $key, 'Initiate', ['class' => 'custom-control-label']) }}<br>
                                                                </div>
                                                            @endif
                                                        @endif
                                                        @if (in_array('create ' . $module, (array) $permissions))
                ...
                <div class="tab-pane fade" id="customer_services" role="tabpanel"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            @if (!empty($permissions))
                                <h6 class="my-3">{{ __('Assign customer services related Permission to Roles') }}
                                </h6>
                                <table class="table table-striped mb-0" id="dataTable-1">
                                        ...
                                        <tr>
                                            <th>
                                                <input type="checkbox" class="form-check-input custom_align_middle"
                                                    name="customer_services_checkall" id="customer_services_checkall">
                                            </th>
                                            <th>{{ __('Module') }} </th>
                                            <th>{{ __('Permissions') }} </th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($modules as $module)
                                            <tr>
                                                <td><input type="checkbox" class="form-check-input ischeck"
                                                        data-id="{{ str_replace(' ', '', $module) }}"></td>
                                                ...
                                                <td>
                                                    <div class="row ">
                                                        ...
                                                        @if ($key = array_search('view ' . $module, $permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{ Form::checkbox('permissions[]', $key, false, ['class' => 'form-check-input isscheck customer_services_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                                {{ Form::label('permission' . $key, 'View', ['class' => 'custom-control-label']) }}<br>
                                                            </div>
                                                        @endif
                                                        {{-- @endif --}}
                                                        ...
                                                        @if (in_array('manage ' . $module, (array) $permissions))
                                                            @if ($key = array_search('manage ' . $module, $permissions))
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    {{ Form::checkbox('permissions[]', $key, $role->permission, ['class' => 'form-check-input isscheck customer_services_checkall isscheck_' . str_replace(' ', '', $module), 'id' => 'permission' . $key]) }}
                                                                    {{ Form::label('permission' . $key, 'Manage', ['class' => 'custom-control-label']) }}<br>
                                                                </div>
                                                            @endif
                                                        @endif
