...
',
    ...
    {
        $toWarehouse = WarehouseProduct::where('warehouse_id', $to_warehouse)
        ...
        $fromWarehouse = WarehouseProduct::where('warehouse_id', $from_warehouse)
                                        ->where('product_id', $product_id)
                                        ->first();
        ...
        if ($fromWarehouse) {
            ...
            \Log::warning("warehouse_transfer_qty: No stock found in from_warehouse (ID: {$from_warehouse}) for product ID {$product_id}.");
        }
    }
