                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        ...
                        <form method="GET" action="{{ route('customer.index') }}">
                            <div class="row my-4 justify-content-end">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('customer.index') }}" class="btn btn-danger">Clear</a>
                                </div>
                            </div>
                        </form>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                @forelse ($customers as $k => $customer)
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3 ms-4">
                            <div>
                                <p>
                                    {{ __('Showing') }} {{ $customers->count() }} {{ __('entries of') }}
                                    {{ $customers->total() }} {{ __('total entries') }}.
                                </p>
                            </div>
                        </div>
