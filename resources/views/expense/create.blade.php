...
@section('content')
    <div class="row">
        {{ Form::open(['route' => 'expense.store', 'class' => 'w-100']) }}
        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            <div class="col">
                                <div class="form-check form-check-inline form-group">
                                    <input type="radio" id="employee_radio" value="employee" name="type"
                                        class="form-check-input {{ isset($_GET['type']) && $_GET['type'] == 'employee' ? 'checked' : 'checked' }}">
                            ...
                            <div class="col employee">
                                <div class="form-group" id="employee-box">
                                    ...
                                    {{ Form::select('employee_id', $employees, null, ['class' => 'form-control select', 'id' => 'employee', 'data-url' => route('expense.employee')]) }}
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::number('totalAmount', null, ['class' => 'form-control', 'required' => 'required']) }}
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                        ...
                        <table class="table datatable mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    <td width="25%" class="form-group pt-0">
                                        {{ Form::select('item', $product_services, '', ['class' => 'form-control select2 item', 'data-url' => route('expense.product')]) }}
                                    </td>
                                    <td>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    {{ Form::hidden('totalAmount', null, ['class' => 'form-control totalAmount']) }}
