        ...
        <a href="{{ route('home') }}" class="b-brand">
            @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on')
                <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                    alt="{{ config('app.name', 'SK ERP') }}" class="logo logo-lg">
            @else
    ...
    <div class="navbar-content">
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                ...
                @if(Gate::check('manage global branches'))
                <li
                    class="dash-item dash-hasmenu
                            {{
                                Request::segment(1) == 'all-branch' 
                                ? 'active dash-trigger'
                                : '' }}">
                    <a href="{{ route('branch.all-branch') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-home"></i></span><span class="dash-mtext">Branches</span>
                    </a>
                </li>
                @endif
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                @if (Gate::check('manage leave') || Gate::check('manage attendance'))
                                    ...
                                    @can('manage provident fund')
                                        <li
                                            class="dash-item  {{ Request::segment(1) == 'provident_fund' ? 'active dash-trigger' : '' }}   ">
                                            <a href="{{ route('provident_fund.index') }}" class="dash-link">
                                                {{ __('Provident Fund') }}
                                            </a>
                                        </li>
                                    @endcan
                ...
                @if (
                    ...
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients' || Request::segment(1) == 'userlogs' ? ' active dash-trigger' : '' }}">
                        <a href="#!"
                        ...
                        <ul class="dash-submenu">
                            ...
                            @can('manage role')
                                ...
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'roles.create' || Request::route()->getName() == 'roles.edit' ? ' active' : '' }} ">
                                    <a class="dash-link"
                                        href="{{ route('permissions.index') }}">{{ __('Permission') }}</a>
                                </li>
                            @endcan
                            {{-- @can('manage client')
                                <li
                    ...
                    <li class="dash-item dash-hasmenu">
                        ...
                        <ul class="dash-submenu">
                            @if (Gate::check('manage product & service'))
                                <li
                                    class="dash-item {{ Request::segment(1) == 'productservice' && Request::segment(2) != 'raw_material' ? 'active' : '' }}">
                                    <a href="{{ route('productservice.index') }}"
                                        class="dash-link">{{ __('Products') }}
                                    </a>
                                </li>
                                <li class="dash-item {{ Request::segment(2) == 'raw_material' ? 'active' : '' }}">
                                    <a href="{{ route('productservice.raw_material.index') }}"
                                        class="dash-link">{{ __('Raw Materials') }}
                                    </a>
                                </li>
                            @endif
                            @if (Gate::check('manage product & service'))
                ...
                @if (Gate::check('manage customer services'))
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show' ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-layers-difference"></i></span><span
                                class="dash-mtext">{{ __('Customer Services') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul
                            class="dash-submenu {{ Request::segment(1) == 'warehouse' || Request::segment(1) == 'purchase' || Request::route()->getName() == 'pos.barcode' || Request::route()->getName() == 'pos.print' || Request::route()->getName() == 'pos.show' ? 'show' : '' }}">
                            @can('manage customer services')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'customer_services.index' || Request::route()->getName() == 'customer_services.show' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('customer_services.index') }}">{{ __('Services') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </li>
                ...
                <!--------------------- Start Ecommerce Managaement System ----------------------------------->
                <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'manage-order' || Request::segment(2) == 'order-details' ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-layers-difference"></i></span><span
                                class="dash-mtext">Ecommerce</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul
                            class="dash-submenu {{ Request::segment(1) == 'manage-order' || Request::segment(2) == 'order-details' ? 'show' : '' }}">
                            @can('manage customer services')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'customer_services.index' || Request::route()->getName() == 'customer_services.show' ? ' active' : '' }}">
                                    <a class="dash-link"
        ...
        @if (\Auth::user()->type == 'client')
            <ul class="dash-navbar">
                ...
                <li
                    class="dash-item dash-hasmenu {{ Request::segment(1) == 'customer_services' ? ' active dash-trigger' : '' }}">
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-layers-difference"></i></span><span
                            class="dash-mtext">{{ __('Customer Services') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul
                        class="dash-submenu {{ Request::segment(1) == 'customer_services' ? 'show' : '' }}">
                        @can('manage customer services')
                            <li
                                class="dash-item {{ Request::route()->getName() == 'customer_services.index' || Request::route()->getName() == 'customer_services.show' ? ' active' : '' }}">
                                <a class="dash-link"
