...
Route::get('/erp/register', [RegisteredUserController::class, 'showRegistrationForm'])
                ->middleware('guest')
                ->name('register');

Route::post('/register', [RegisteredUserController::class, 'store'])
                ->middleware('guest')->name(name: 'makeregister');

Route::get('/erp/login', [AuthenticatedSessionController::class, 'showLoginForm'])
                ->middleware('guest')
                ->name('login');

Route::post('/login', [AuthenticatedSessionController::class, 'store'])
                ->middleware('guest')->name('makelogin');
