{{ Form::open(['route' => ['productservice.import'], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            {{ Form::label('file', __('Download sample product CSV file'), ['class' => 'form-label']) }}
            <a href="{{ Storage::url('uploads/sample/sample-product.csv') }}" class="btn btn-sm btn-primary" download>
