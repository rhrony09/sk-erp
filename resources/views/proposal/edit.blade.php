                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                    ...
                                    {{ Form::select('customer_id', $customers,null, array('class' => 'form-control select2 ','id'=>'customer','data-url'=>route('proposal.customer'),'required'=>'required')) }}
                            </div>
                        ...
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-0">
                                    {{ Form::select('item', $product_services,null, array('class' => 'form-control select2 item','data-url'=>route('proposal.product'))) }}
                                </td>
                                <td>
