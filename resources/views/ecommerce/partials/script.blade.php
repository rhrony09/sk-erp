<!-- all js include here -->
<script src="{{asset('assets/js-ecom/vendor/jquery-1.12.4.min.js')}}"></script>
<script src="{{asset('assets/js-ecom/ajax.js')}}"></script>
<script src="{{asset('assets/js-ecom/bootstrap.min.js')}}"></script>
